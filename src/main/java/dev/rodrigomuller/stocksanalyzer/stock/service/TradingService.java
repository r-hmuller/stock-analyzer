...
public class TradingService {
    ...
    @Autowired
    public TradingService(StockService stockService, TradingRepository tradingRepository, CompanyRepository companyRepository, TradingMapper tradingMapper) {
